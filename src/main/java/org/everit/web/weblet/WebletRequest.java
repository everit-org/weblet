...
public interface WebletRequest {
   ...
   * @return the value of the attribute, or <code>null</code> if there is no attribute with the
   *         given name
   *
   ...
   * server, for example, <code>BASIC_AUTH</code>, <code>CLIENT_CERT_AUTH</code>, a custom one or
   * <code>null</code> if there was no authentication.
   *
   * @return a string indicating the authentication scheme, or <code>null</code> if the request was
   *         not authenticated.
   *
   ...
   *
   * @return a String containing the name of the character encoding, or null if the request does not
   ...
   *
   * @return a string containing the name of the MIME type of the request, or null if the type is
   *         not known
   *
   ...
   * path always comes first in a request URI.
   *
   * @see HttpServletRequest#getContextPath()
   * @see PortletRequest#getContextPath()
   *
   * @return a String specifying the portion of the request URI that indicates the context of the
   *         request
   */
   ...
   * header can't be converted to a date, the method throws an IllegalArgumentException.
   *
   * @param name
   ...
   *         milliseconds since January 1, 1970 GMT, or -1 if the named header was not included with
   *         the request
  ...
  /**
   * Gets the value of a request header, e.g. a http header for a {@link HttpServletRequest}.
   *
   * @param headerName
   *          the name of the header
   * @return the header value, or <code>null</code> if the header is not present in the request
   *
   ...
   * <p>
   * Some implementations do not allow access headers using this method, in which case this method
   * returns <code>null</code>
   *
   * @return an enumeration of all the header names sent with this request; if the request has no
   *         headers, an empty enumeration; if the implementation does not allow this method,
   *         <code>null</code>
   ...
   * Enumeration. If the request does not support accessing headers, this method returns
   * <code>null</code>.
   * <p>
   ...
   * @return an Enumeration containing the values of the requested header. If the request does not
   *         have any headers of that name return an empty enumeration. If the header information is
   *         not available, return <code>null</code>
   * @see HttpServletRequest#getHeaders(String)
   */
  Enumeration<String> getHeaders(String name);

  /**
   * Returns an input stream from which the request content can be read. The request content length
   * can be obtained with {@link #getContentLength()} without reading the full stream contents.
   *
   * @see javax.servlet.ServletRequest#getInputStream()
   * @see javax.portlet.ClientDataRequest#getPortletInputStream()
   *
   * @return the input stream from which the contents of the request can be read
   * @throws IOException
   ...
   * preferred locale, the locales that are acceptable to the client based on the Accept-Language
   * header. If the client request doesn't provide an Accept-Language header, this method returns an
  ...
  /**
   * Gets the named request parameter This is typically a HTTP GET or POST parameter, though other
   * request types might have other ways of representing parameters.
   *
   ...
   * @return The paramter value, or <code>null</code> if no parameter with the given name is present
   */
  String getParameter(String parameter);

  /**
   * Gets all the parameters of the request. Framework's internal init parameters have prefix "v-"
   * (does not include such parameters as "theme" and "debug").
   *
   ...
   * <code>null</code> if no path information is available. Does always start with / if the path
   * isn't <code>null</code>.
   *
  ...
  /**
   * Retrieves the body of the request as character data using a <code>BufferedReader</code>. The
  ...
  /**
   * Returns the IP address from which the request came. This might also be the address of a proxy
   * between the server and the original requester.
   *
   * @return a string containing the IP address, or <code>null</code> if the address is not
   *         available
   *
   ...
   *
   * @return a String containing the fully qualified name of the client, or <code>null</code> if the
   ...
   * request.
   *
   * @return an integer specifying the port number, or -1 if the information is not available.
   *
   ...
   * if the user has not been authenticated. Whether the user name is sent with each subsequent
   * request depends on the browser and type of authentication.
   *
   * @return a String specifying the login of the user making this request, or <code>null</code> if
